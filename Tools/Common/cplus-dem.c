...
char *xrealloc PARAMS((char *, unsigned));
...
char *
cplus_mangle_opname (char *opname, int options)
{
  int i;
  int len;
...
static int cplus_match (const char *mangled, char *text, int text_len)
{
...
static int
demangle_template (struct work_stuff *work, const char **mangled, string *tname, string *trawname)
{
  int i;
  int is_pointer;
  int is_real;
...
static void
demangle_arm_pt (struct work_stuff *work, const char **mangled, int n, string *declp)
{
  const char *p;
  const char *args;
