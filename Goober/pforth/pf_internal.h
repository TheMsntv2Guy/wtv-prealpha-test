...
typedef struct cfTaskData
{
	...
	cell   *td_ReturnLimit;
#ifdef PF_SUPPORT_FP
	FLOAT  *td_FloatStackPtr;
	FLOAT  *td_FloatStackBase;
	FLOAT  *td_FloatStackLimit;
#endif
