...
const char _kEmptyString[] = {'\0'};

#define XDI (_DI|_XD)	/* digit and hex digit (0-9) */
#define XLO (_LO|_XD)	/* lower and hex digit (a-f) */
#define XUP (_UP|_XD)	/* upper and hex digit (A-F) */

static const short ctype_table[257] = {0, /* EOF */
...
static const short tolower_table[257] = {EOF,
...
static const short toupper_table[257] = {EOF,
	0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
	0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
	0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
	0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f,
...
const short *_BoxCtype   = &ctype_table[1];
const short *_BoxTolower = &tolower_table[1];
const short *_BoxToupper = &toupper_table[1];

// in case someone wants a function instead of a macro
