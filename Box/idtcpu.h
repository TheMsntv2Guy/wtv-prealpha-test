...
#define	C_VEC	(K0BASE+0x100)		/* Cache Error Exception Vector */
#define	I_VEC	(K0BASE+0x200)		/* Interrupt Vector (if Cause.IV = 1) */
#define E_VEC	(K0BASE+0x180)		/* General Exception Vector */
